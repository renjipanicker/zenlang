...
namespace Ast {
    ...
    private:
        ...
        inline Ast::RootFunctionDecl& addRootFunctionDecl(const Ast::TypeSpec& parent, const Ast::FunctionSig& functionSig, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
        inline Ast::ChildFunctionDecl& addChildFunctionDecl(const Ast::TypeSpec& parent, const Ast::Token& name, const Ast::DefinitionType& defType, const Ast::TypeSpec& base, const Ast::ClosureRef& cref);
        ...
        inline Ast::ChildFunctionDefn& createChildFunctionDefn(Ast::TypeSpec& parent, const Ast::Function& base, const Ast::Token& name, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
    ...
    public:
        ...
        Ast::Module::Level_t     aImportStatement(const Ast::Token& pos, const Ast::AccessType::T& accessType, const Ast::HeaderType::T& headerType, const Ast::DefinitionType& defType, Ast::NamespaceList& list, z::string& filename);
    ...
    public:
        Ast::TypedefDecl*        aTypedefDecl(const Ast::Token& name, const Ast::DefinitionType& defType);
        ...
        Ast::StructDecl*         aStructDecl(const Ast::Token& name, const Ast::DefinitionType& defType);
        ...
        Ast::PropertyDeclRW*     aStructPropertyDeclRW(const Ast::Token& pos, const Ast::QualifiedTypeSpec& propertyType, const Ast::Token& name, const Ast::DefinitionType& defType);
        Ast::PropertyDeclRO*     aStructPropertyDeclRO(const Ast::Token& pos, const Ast::QualifiedTypeSpec& propertyType, const Ast::Token& name, const Ast::DefinitionType& defType);
        Ast::RoutineDecl*        aRoutineDecl(const Ast::QualifiedTypeSpec& outType, const Ast::Token& name, Ast::Scope& in, const Ast::DefinitionType& defType);
        Ast::RoutineDecl*        aVarArgRoutineDecl(const Ast::QualifiedTypeSpec& outType, const Ast::Token& name, const Ast::DefinitionType& defType);
        Ast::RoutineDefn*        aRoutineDefn(Ast::RoutineDefn& routineDefn, const Ast::CompoundStatement& block);
        Ast::RoutineDefn*        aEnterRoutineDefn(const Ast::QualifiedTypeSpec& outType, const Ast::Token& name, Ast::Scope& in, const Ast::DefinitionType& defType);
        Ast::RootFunctionDecl*   aRootFunctionDecl(const Ast::FunctionSig& functionSig, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
        Ast::ChildFunctionDecl*  aChildFunctionDecl(const Ast::TypeSpec& base, const Ast::Token& name, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
        Ast::RootFunctionDefn*   aRootFunctionDefn(Ast::RootFunctionDefn& functionDefn, const Ast::CompoundStatement& block);
        Ast::RootFunctionDefn*   aEnterRootFunctionDefn(const Ast::FunctionSig& functionSig, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
        Ast::ChildFunctionDefn*  aChildFunctionDefn(Ast::ChildFunctionDefn& functionImpl, const Ast::CompoundStatement& block);
        Ast::ChildFunctionDefn*  aEnterChildFunctionDefn(const Ast::TypeSpec& base, const Ast::Token& name, const Ast::DefinitionType& defType, const Ast::ClosureRef& cref);
        Ast::RootInterfaceDefn*  aLeaveRootInterfaceDefn(Ast::RootInterfaceDefn& InterfaceDefn);
        Ast::RootInterfaceDefn*  aEnterRootInterfaceDefn(const Ast::Token& name, const Ast::DefinitionType& defType);
        void                     aInterfaceMemberTypeDefn(Ast::UserDefinedTypeSpec& typeSpec);
        Ast::EventDecl*          aEventDecl(const Ast::Token& pos, const Ast::VariableDefn& in, const Ast::DefinitionType& eventDefType, const Ast::FunctionSig& functionSig, const Ast::DefinitionType& handlerDefType);
