...
#if defined(WIN32)
    Window::Handle::Impl& impl = Window::Native::createMainFrame(def, WS_OVERLAPPEDWINDOW, WS_EX_WINDOWEDGE);
    ::PostMessage(impl._hWindow, WM_SIZE, 0, 0);
#endif
#if defined(GTK)
    Window::Handle::Impl& impl = Window::Native::createWindow(def, 0);
